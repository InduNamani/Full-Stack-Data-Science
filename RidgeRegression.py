...
st.set_page_config("Ridge Regression - Salary Prediction", layout="centered")
...
st.markdown("""
            ...
            <p>Predicting <b>Employee Salary</b> based on Years of Experience, Age, and Education Level using <b>L2 Regularization</b>.</p>
            </div>
...
# Train Ridge model
alpha_value = st.sidebar.slider("Ridge Alpha (Regularization Strength)", 0.01, 10.0, 1.0)
...
# ---------------- VISUALIZATIONS ----------------
st.markdown('<div class="card">', unsafe_allow_html=True)
st.subheader("📈 Feature Impact on Salary")

fig, ax = plt.subplots(figsize=(10, 5))
features = ['Experience', 'Age', 'Education']
coefficients = model.coef_
colors = ['#fa709a', '#fee140', '#a8edea']
...
st.info("💡 **Interpretation**: Positive values mean higher feature values increase salary. Larger bars = stronger impact.")
st.markdown('</div>', unsafe_allow_html=True)
...
ax.scatter(y_test, y_pred, alpha=0.6, color='#fa709a', edgecolors='black')
